...
$email_check = "SELECT * from reg where email = '{$user_email}'";
...
<?php
   ...
   $query = "INSERT INTO `reg` (`username`, `email`, `password`) VALUES ('$user_name', '$user_email', '$pass')";
   $res = mysqli_query($conn ,$query);

}
header("location:http://localhost:82/ap/login.php");
}
            ...
            <div class="row ">
               <div class="col-md-8 offset-md-2">
                  ...
                  <form id="request" class="main_form" action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
                     <div class="row">
                        <div class="col-md-12">
                           <input class="contactus" placeholder="Name" type="text" name="username"> 
                        </div>
                        <div class="col-md-12">
